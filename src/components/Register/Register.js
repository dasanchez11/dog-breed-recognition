...
class Register extends React.Component {
  ...
  onSubmitRegister = () =>{
    fetch('https://limitless-wave-40652.herokuapp.com/register', {
      method:'post',
  ...
  render(){
    ...
    return (
      <article className="br3 bw2 ba dark-gray b--black-50 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-blue o-80">
